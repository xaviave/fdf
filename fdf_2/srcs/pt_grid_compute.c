...
/*   Updated: 2018/03/06 14:09:43 by xamartin    ###    #+. /#+    ###.fr     */
/*                                                         /                  */
/*                                                        /                   */
/* ************************************************************************** */
...
static void	ft_init_mtx(t_mem *mem, t_mtx *mtx)
{
	...
	mtx->data[0][1] = (mtx->data[1][0] * mtx->data[2][2])
		- (mtx->data[2][0] * mtx->data[1][2]);
	mtx->data[1][1] = (mtx->data[2][0] * mtx->data[0][2])
		- (mtx->data[0][0] * mtx->data[2][2]);
	mtx->data[2][1] = (mtx->data[0][0] * mtx->data[1][2])
		- (mtx->data[1][0] * mtx->data[0][2]);
}
